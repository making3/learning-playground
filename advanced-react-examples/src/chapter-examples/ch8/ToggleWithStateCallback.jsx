...
const NavigationController = ({ children }) => {
  ...
  const api = useMemo(() => {
    return {
      ...
      toggle: () => setIsNavExpanded((isNavExpanded) => !isNavExpanded),
    };
...
export default function ToggleWithStateCallback() {
  return <Page />;
}

ToggleWithStateCallback.title = 'Toggle (memo) Using State Callback';
